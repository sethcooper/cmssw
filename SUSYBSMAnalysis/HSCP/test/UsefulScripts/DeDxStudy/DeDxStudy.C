...
void DeDxStudy(string MODE="COMPILE")
{
...
//   string SampleId = "MC_13TeV_DYToMuMu";
   string SampleId = "Gluino_13TeV_M1500_f10";
...
//      trackCollHandle.getByLabel(ev,"generalTracks");
      ...
      for(unsigned int c=0;c<trackCollHandle->size();c++){
          ...
          DeDxData* dedxSObj = computedEdx(dedxHits, dEdxSF, dEdxTemplates, false, useClusterCleaning, false );
